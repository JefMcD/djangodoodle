"""
Django settings for doodle_proj project.
...
WSGI_APPLICATION = 'doodle_proj.wsgi.application'
...
'''
switch this over to postgress when the time comes
DATABASES = {
    'default': {
...
AUTH_USER_MODEL = "doodle_app.User" # Abstract User model
