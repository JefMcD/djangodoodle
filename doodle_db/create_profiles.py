...
def install_user_profiles(sddoodle_app_users):
    # install_fs_user_area(sddoodle_app_users)
...
'''
def install_fs_user_area(sddoodle_app_users):
    ...
    # base_dir = /home/artillery/webdev-apps/courses/CS50/Project-4/sddoodle_app
    ...
    for user in sddoodle_app_users:  
        # so user  == something like {'username':'pepe', 'email': 'pepe@mail.com', 'password': 'passw0rd'},
        sddoodle_app_username = user['username'] 
        current_user = User.objects.get(username = sddoodle_app_username)
